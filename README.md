...
- **[wifi-presence-detection](https://github.com/Nur2424/wifi-presence-detection)**
  ...
  framed as anomaly detection. Three models trained only on empty-room
  data and compared under one protocol: Isolation Forest, MLP
  autoencoder, and CNN autoencoder. CNN wins on F1 (0.919), Isolation
  Forest on ROC-AUC (0.928). Built for the AI Lab course, with an
  IEEE-format paper.
