...
Tensor-level autograd engine built from scratch the natural extension of microgradplus from scalar to matrix operations. Hand-derived gradients for matmul, softmax, cross-entropy, and layer norm. Work in progress.
